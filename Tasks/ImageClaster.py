...
image = skimage.img_as_float(imread('../source/parrots.jpg'))
w, h, d = image.shape
...
def cluster(pixels, n_clusters=8):
    ...
    imsave('../source/images/mean/parrots_' + str(n_clusters) + '.jpg', mean_image)
    ...
    imsave('../source/images/median/parrots_' + str(n_clusters) + '.jpg', median_image)
